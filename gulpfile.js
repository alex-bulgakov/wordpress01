...
gulp.task("styles", function () {
	return (
		gulp
		.src("src/wp-content/themes/fictional-university-theme/sass/**/*.sass")
		.pipe(
			sass({
				outputStyle: "expand",
		...
		.pipe(gulp.dest("src/wp-content/themes/fictional-university-theme/css"))
...
gulp.task("scripts", function () {
	return gulp
		.src([
			"src/wp-content/themes/fictional-university-theme/js/**/*.js",
		...
		.pipe(gulp.dest("src/wp-content/themes/fictional-university-theme/js/"))
		.pipe(
			browsersync.reload({
				stream: true,
			})
...
gulp.task("imgmin-theme", function () {
	return gulp
		.src("src/wp-content/themes/fictional-university-theme/images/**/*")
		.pipe(cache(imagemin())) // Cache Images
		.pipe(gulp.dest("src/wp-content/themes/fictional-university-theme/images"));
});
...
gulp.task("deploy-theme", function () {
	...
	var globs = [
		"src/wp-content/themes/fictional-university-theme/**", // Путь до шаблона у вас на компьютере
	];
	return gulp
		.src(globs, {
			buffer: false,
...
if (gulpversion == 3) {
	gulp.task("watch", ["styles", "scripts", "browser-sync"], function () {
		gulp.watch(
			["src/wp-content/themes/fictional-university-theme/sass/**/*.sass"],
			["styles"]
		); // Наблюдение за sass файлами в папке sass в теме
		gulp.watch(
			["src/wp-content/themes/fictional-university-theme/**/*.js"],
			["scripts"]
...
if (gulpversion == 4) {
	gulp.task("watch", function (done) {
		...
		gulp.watch(
			[
				"src/wp-content/themes/fictional-university-theme/js/**/*.js",
				"!src/wp-content/themes/fictional-university-theme/js/**/*.min.js",
			],
			gulp.parallel("scripts")
		); // Наблюдение за JS файлами в папке js
		gulp.watch(
			"src/wp-content/themes/fictional-university-theme/**/*.php",
			function (done) {
				browsersync.reload();
				done();
			}); // Наблюдение за sass файлами php в теме

! function (t) {
  ...
  }, n.p = "/wp-content/themes/fictional-university-theme/bundled-assets/", n(n.s = 1)
  ...
  function y(t, e, n) {
    var i = {};
    for (var r in e) p(e[r]) ? i[r] = e[r](t, i, n) : o("Extension must be a function");
  ...
  function w(t, e) {
    var n = c({}, t, e);
    return e.hasOwnProperty("classes") && (n.classes = c({}, t.classes, e.classes), e.classes.hasOwnProperty("direction") && (n.classes.direction = c({}, t.classes.direction, e.classes.direction))), e.hasOwnProperty("breakpoints") && (n.breakpoints = c({}, t.breakpoints, e.breakpoints)), n
  }
  var _ = function () {
      function t() {
        var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
        u(this, t), this.events = e, this.hop = e.hasOwnProperty
      }
      return a(t, [{
        key: "on",
        value: function (t, e) {
    ...
    k = function () {
      function t(e) {
        ...
        u(this, t), this._c = {}, this._t = [], this._e = new _, this.disabled = !1, this.selector = e, this.settings = w(r, n), this.index = this.settings.startAt
      }
      return a(t, [{
        key: "mount",
        value: function () {
          var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
          return this._e.emit("mount.before"), v(t) ? this._c = y(this, t, this._e) : o("You need to provide a object on `mount()`"), this._e.emit("mount.after"), this
        }
      }, {
        key: "mutate",
        value: function () {
          var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : [];
          return g(t) ? this._t = t : o("You need to provide a array on `mutate()`"), this
        }
      }, {
        key: "update",
        value: function () {
  ...
  function H(t, e, n) {
    ...
    n || (n = {});
    var a = function () {
        u = !1 === n.leading ? 0 : S(), i = null, s = t.apply(r, o), i || (r = o = null)
      },
      c = function () {
        var c = S();
        u || !1 !== n.leading || (u = c);
  ...
  var V = {
      Html: function (t, e) {
        ...
        return b(n, "root", {
          ...
          set: function (t) {
            h(t) && (t = document.querySelector(t)), O(t) ? n._r = t : o("Root element must be a existing Html node")
          }
        }), b(n, "track", {
          get: function () {
            return n._t
          ...
          set: function (t) {
            O(t) ? n._t = t : o('Could not find track element. Please use [data-glide-el="track"] attribute.')
          }
        }), b(n, "wrapper", {
          get: function () {
        ...
        var i = {
          set: function (n) {
            var i = function (t, e, n) {
              var i = [L, C, z, E].concat(t._t, [P]);
              return {
                mutate: function (r) {
                  for (var s = 0; s < i.length; s++) {
                    var u = i[s];
                    p(u) && p(u().modify) ? r = u(t, e, n).modify(r) : o("Transformer should be a function that returns an object with `modify()` method")
                  }
                  return r
                }
              }
      ...
      Direction: function (t, e, n) {
        ...
        return b(i, "value", {
          ...
          set: function (t) {
            M.indexOf(t) > -1 ? i._v = t : o("Direction value must be `ltr` or `rtl`")
          }
        ...
        var i = {
          apply: function (t) {
            for (var n = 0, i = t.length; n < i; n++) {
              var r = t[n].style,
                o = e.Direction.value;
              r[T[o][0]] = 0 !== n ? this.value / 2 + "px" : "", n !== t.length - 1 ? r[T[o][1]] = this.value / 2 + "px" : r[T[o][1]] = ""
            }
          },
          remove: function (t) {
      ...
      Build: function (t, e, n) {
        var i = {
          ...
          activeClass: function () {
            ...
            i && (i.classList.add(n.activeSlide), x(i).forEach((function (t) {
      ...
      Run: function (t, e, n) {
        var i = {
          ...
          calculate: function () {
            var e = this.move,
              ...
              i = e.steps,
              r = e.direction,
              s = "number" == typeof d(i) && 0 !== d(i);
            switch (r) {
              case ">":
                ">" === i ? t.index = n : this.isEnd() ? t.isType("slider") && !t.settings.rewind || (this._o = !0, t.index = 0) : s ? t.index += Math.min(n - t.index, -d(i)) : t.index++;
                break;
              case "<":
                "<" === i ? t.index = 0 : this.isStart() ? t.isType("slider") && !t.settings.rewind || (this._o = !0, t.index = n) : s ? t.index -= Math.min(t.index, d(i)) : t.index--;
                break;
              case "=":
                t.index = i;
                break;
              default:
                o("Invalid direction pattern [" + r + i + "] has been used")
            }
          },
          isStart: function () {
            return 0 === t.index
        ...
        return b(i, "move", {
          ...
          get: function () {
            ...
            return t.isType("slider") && "center" !== n.focusAt && n.bound ? i - 1 - (d(n.perView) - 1) + d(n.focusAt) : i - 1
          }
        }), b(i, "offset", {
          get: function () {
            return this._o
          ...
          c = {
            ...
            move: function (i) {
              ...
              if (!t.disabled) {
                ...
                this.enable(), c > a && l < s.touchAngle ? (s.perTouch && (f = Math.min(f, d(s.perTouch))), e.Direction.is("rtl") && (f = -f), e.Run.make(e.Direction.resolve("<" + f))) : c < -a && l < s.touchAngle ? (s.perTouch && (f = Math.max(f, -d(s.perTouch))), e.Direction.is("rtl") && (f = -f), e.Run.make(e.Direction.resolve(">" + f))) : e.Move.make(), e.Html.root.classList.remove(s.classes.dragging), this.unbindSwipeMove(), this.unbindSwipeEnd(), n.emit("swipe.end")
              }
            },
            bindSwipeStart: function () {
              var n = this,
                r = t.settings;
              r.swipeThreshold && i.on(B[0], e.Html.wrapper, (function (t) {
                n.start(t)
              }), a), r.dragThreshold && i.on(B[1], e.Html.wrapper, (function (t) {
                n.start(t)
              }), a)
            },
            unbindSwipeStart: function () {
              i.off(B[0], e.Html.wrapper, a), i.off(B[1], e.Html.wrapper, a)
            },
            bindSwipeMove: function () {
              var n = this;
              i.on(W, e.Html.wrapper, H((function (t) {
                n.move(t)
              }), t.settings.throttle), a)
            },
            unbindSwipeMove: function () {
              i.off(W, e.Html.wrapper, a)
            },
        ...
        var i = new A,
          ...
          o = {
            ...
            addClass: function (e) {
              var n = t.settings,
                i = e[t.index];
              i && (i.classList.add(n.classes.activeNav), x(i).forEach((function (t) {
      ...
      Breakpoints: function (t, e, n) {
        ...
        return c(r, u.match(o)), i.on("resize", window, H((function () {
    ...
    F = function (t) {
      ...
      return function (t, e) {
        ...
        value: function () {
          var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
          return l(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "mount", this).call(this, c({}, V, t))
        }
      }]), e
    }(k);
  var Y = class {
    constructor() {
      if (document.querySelector(".hero-slider")) {
        ...
        document.querySelector(".glide__bullets").insertAdjacentHTML("beforeend", e), new F(".hero-slider", {
          type: "carousel",
          perView: 1,
          autoplay: 3e3
        }).mount()
